...
clientes_ativos_page = html.Div([
    ...
    html.Div([
        ...
        html.Div([
            html.H3(f"{df['perfil_risco_ips'].mean():.1f}", className="card-value"),
...
tabela_clientes_page = html.Div([
    ...
    html.Div([
        ...
        dcc.Dropdown(
            ...
            options=[
                ...
                {"label": "Suitability Cliente", "value": "suitability_cliente"},
    ...
    dt.DataTable(
        ...
        style_header={"backgroundColor": "#1b51b1", "color": "white", "fontWeight": "bold"},
...
@app.callback(
    ...
    [Input("update-data-btn", "n_clicks"), Input("search-bar", "value"), Input("filter-column", "value")]
)
